 ...
 */
 ...
 public class Juego {
     ...
     public void nuevoFotogramaDeJuego() {
         ...
         ventana.dibujaRectangulo(0,0,MARGEN,ventana.getAlturaLienzo(), Color.white);
         ventana.dibujaRectangulo(getCoordenadaXMargenDerecho(), 0, MARGEN, ventana.getAlturaLienzo(), Color.white);
         ventana.dibujaRectangulo(0, getCoordenadaYSuelo(), ventana.getAnchuraLienzo(), MARGEN, Color.white);
         ...
         ventana.escribeTexto("Punts: " + puntuacion, 30, 20, 18, Color.white);
     }
     ...
     public void finDeJuego() {
         ventana.escribeTexto("Fi de Joc!", 130, 200, 64, Color.black);
         ventana.escribeTexto("Clica l'espai per tornar a començar", 100, 220, 20, Color.white);
         ventana.mostrarLienzo();
         ...
         while (!ventana.isPulsadoEspacio()) {
            try {
                Thread.sleep(10); // Agregar un pequeño retardo
      ...
      */
      public void presentacion() {
        ventana.borrarLienzoOculto();
        ventana.escribeTexto("MOO Pang!", 150, 150, 64, Color.black);
        ventana.escribeTexto("Clica espai per començar", 120, 420,30, Color.white);
        ventana.mostrarLienzo();
        while (!ventana.isPulsadoEspacio()) {
            try {
                Thread.sleep(10); // Agregar un pequeño retardo
