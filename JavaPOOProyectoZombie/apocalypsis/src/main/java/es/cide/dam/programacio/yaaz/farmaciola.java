...
/*Creamos una clase farmaciola que extiende de nuestra clase artefactes */
public class farmaciola extends artefactes{

    /*Creamos un nuevo constructor de farmaciola donde solo le pasaremos por parametro el pes*/
    public farmaciola(int pes){
        ...
        /*Este método establece el valor de un atributo de la clase farmaciola */
