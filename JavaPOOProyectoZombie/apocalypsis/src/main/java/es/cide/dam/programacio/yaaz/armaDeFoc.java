...
/*Creamos una clase armaDeFoc que extiende de nuestra clase artefactes */
public class armaDeFoc extends artefactes{

    /*Creamos un nuevo constructor de armaDeFoc donde solo le pasaremos por parametro el pes*/
    public armaDeFoc(int pes){
        ...
        /*Este método establece el valor de un atributo de la clase armaDeFoc */
