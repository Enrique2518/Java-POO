...
public class moto extends vehicle implements Conduir, Habilitat{
    ...
    public void albergarPersones() {
        if (capacitat > 2) {
            System.out.println("No es posible meter a tanta gente el en cotxe. Pondremos solo 2 personas.");
        }else{
